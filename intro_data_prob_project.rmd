...
**Research question 2: Are people who vote more likely to exercise than those that don't, and is there a difference between genders? As both are optional activities it would be interesting to see if those motivated enough to vote also motivated enough to exercise.**
<ul>
...
ggplot(data = vector_summary, aes(x = income, ))
```
